...
internal class TextToImageUseCaseImpl(
    ...
    private val localDiffusionCppGenerationRepository: LocalDiffusionCppGenerationRepository,
    ...
    private fun generate(payload: TextToImagePayload) = when (preferenceManager.source) {
        ...
        ServerSource.LOCAL_MICROSOFT_ONNX -> localDiffusionOnnxGenerationRepository.generateFromText(payload)
        ...
        ServerSource.LOCAL_CPP -> localDiffusionCppGenerationRepository.generateFromText(payload)
    }
}
