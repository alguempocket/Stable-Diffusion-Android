...
class LocalDiffusionONNXGenerationRepositoryImplTest {
    ...
    private val stubLocalDiffusion = mockk<LocalDiffusionONNX>()
    ...
    private val repository = LocalDiffusionOnnxGenerationRepositoryImpl(
