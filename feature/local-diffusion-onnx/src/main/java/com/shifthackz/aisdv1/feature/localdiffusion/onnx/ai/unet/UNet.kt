...
package com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.unet
...
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.KEY_ENCODER_HIDDEN_STATES
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.KEY_LATENT_SAMPLE
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.KEY_SAMPLE
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.KEY_TIME_STEP
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.ORT
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.ORT_KEY_MODEL_FORMAT
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.TAG
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.duplicate
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.getSizes
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.multipleTensorsByFloat
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.splitTensor
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.scheduler.EulerAncestralDiscreteLocalDiffusionScheduler
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.vae.VaeDecoder
...
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.extensions.modelPathPrefix
...
internal class UNet(
    ...
    private val localOnnxModelIdProvider: LocalOnnxModelIdProvider,
    ...
    fun initialize() {
        ...
        session = ortEnvironmentProvider.get().createSession(
            "${modelPathPrefix(preferenceManager, fileProviderDescriptor, localOnnxModelIdProvider)}/${LocalDiffusionContract.UNET_MODEL}",
            options
        )
    }
