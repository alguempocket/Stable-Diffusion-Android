...
package com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.tokenizer
...
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.LocalDiffusionContract.KEY_INPUT_IDS
...
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.halfCorner
import com.shifthackz.aisdv1.feature.localdiffusion.onnx.ai.extensions.toArrays
...
internal class EnglishTextTokenizer(
    ...
    private fun loadEncoder(): Map<String, Int> {
        ...
        try {
            val path = "${modelPathPrefix(preferenceManager, fileProviderDescriptor, localOnnxModelIdProvider)}/${LocalDiffusionContract.TOKENIZER_VOCABULARY}"
    ...
    private fun loadBpeRanks(): Map<Pair<String, String>, Int?> {
        ...
        try {
            val path = "${modelPathPrefix(preferenceManager, fileProviderDescriptor, localOnnxModelIdProvider)}/${LocalDiffusionContract.TOKENIZER_MERGES}"
